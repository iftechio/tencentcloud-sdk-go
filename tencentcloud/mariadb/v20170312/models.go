...
func (r *CreateTmpInstancesRequest) FromJsonString(s string) error {
	...
	if len(f) > 0 {
		return errors.New("CreateTmpInstancesRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeDBInstanceSpecsRequest) FromJsonString(s string) error {
	...
	if len(f) > 0 {
		return errors.New("DescribeDBInstanceSpecsRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribePriceRequest) FromJsonString(s string) error {
	...
	delete(f, "Paymode")
	if len(f) > 0 {
		return errors.New("DescribePriceRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeRenewalPriceRequest) FromJsonString(s string) error {
	...
	delete(f, "Period")
	if len(f) > 0 {
		return errors.New("DescribeRenewalPriceRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeSaleInfoRequest) FromJsonString(s string) error {
	...
	if len(f) > 0 {
		return errors.New("DescribeSaleInfoRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
...
func (r *DescribeUpgradePriceRequest) FromJsonString(s string) error {
	...
	delete(f, "Storage")
	if len(f) > 0 {
		return errors.New("DescribeUpgradePriceRequest has unknown keys!")
	}
	return json.Unmarshal([]byte(s), &r)
}
